package com.jeddi.myflexiblefragment
...
class CategoryFragment : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.btn_detail_category) {
            ...
            jika ada fragment di dalam backstack maka fragment yang akan di
            close / remove
            jika sudah tidak ada fragment di dalam backstack maka activity
            yang akan di close / finish
            */
